...
const products = [
  { Symbol: 'GOOG', Side: 'Buy', Quantity: '10', Account: 'test', Broker: 'BBG' },
  { Symbol: 'AAPL', Side: 'Sell', Quantity: '10', Account: 'test', Broker: 'BBG' },
  { Symbol: 'IBM', Side: 'Buy', Quantity: '10', Account: 'test', Broker: 'BBG' },
  { Symbol: 'A', Side: 'Sell', Quantity: '10', Account: 'test', Broker: 'BBG' },
  { Symbol: 'GOOG', Side: 'Buy', Quantity: '10', Account: 'test', Broker: 'BBG' },
  { Symbol: 'AAPL', Side: 'Sell', Quantity: '10', Account: 'test', Broker: 'BBG' },
  { Symbol: 'IBM', Side: 'Buy', Quantity: '10', Account: 'test', Broker: 'BBG' },
  { Symbol: 'A', Side: 'Sell', Quantity: '10', Account: 'test', Broker: 'BBG' },
